        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <form className="mt-6 flex gap-2" onSubmit={(e) => {
              ...
              <input 
                ...
                className="flex-1 px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white text-sm"
                required
              />
              <button 
                type="submit" 
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/nosotros" className="text-sm text-zinc-500 hover:text-white transition-colors">
                  Nosotros
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/envios" className="text-sm text-zinc-500 hover:text-white transition-colors">
                  Envíos
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/pagos" className="text-sm text-zinc-500 hover:text-white transition-colors">
                  Política de Pagos
                </Link>
              </li>
              <li>
                <Link href="/devoluciones" className="text-sm text-zinc-500 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/tutorial" className="text-sm text-zinc-500 hover:text-white transition-colors">
                  Cómo Utilizar
                </Link>
              </li>
              <li>
                <Link href="/soporte" className="text-sm text-zinc-500 hover:text-white transition-colors">
                  Soporte
                </Link>
              </li>
            </ul>
